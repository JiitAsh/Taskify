...
public class TasksDTOResponse {
	...
	public TasksDTOResponse(int task_id, String task_title, String task_desc, String task_category, String location,
			String task_type, Double budget, LocalDateTime scheduledDate, String mustHaves, TaskStatus status,
			LocalDateTime createdAt, LocalDateTime updatedAt, UsersTable user, String message) {
